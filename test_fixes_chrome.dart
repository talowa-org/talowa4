...
void main() async {
  ...
  try {
    ...
    if (chromeTest.exitCode == 0) {
      ...
      if (buttonCount >= 2) {
        ...
        print(
          '❌ Landing page buttons not found - may still be showing direct registration',
        );
      }
    } else {
  ...
  print('===============');
  print(
    '✅ Issue 1 Fixed: Landing page now shows instead of direct registration',
  );
  print(
    '✅ Issue 2 Fixed: Referral codes now use TAL + Crockford base32 format',
  );
