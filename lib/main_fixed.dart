...
class TalowaFixedApp extends StatelessWidget {
  const TalowaFixedApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'TALOWA - Registration + Login',
      theme: AppTheme.lightTheme,
      debugShowCheckedModeBanner: false,
      home: const LandingScreen(),
      routes: {
        '/register': (context) => RegistrationErrorBoundary(
...
// Landing screen with Login and Register buttons
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Landing page restored.\nReferral codes now use TAL format.',
                      style: TextStyle(
                        fontSize: 14,
